...
public class OrderListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView subTitleTextView = (TextView) convertView.findViewById(R.id.textView4) ;
    ...
    public void addItem(Drawable icon, String title, String desc, String subtitle, String sub) {
